...
# ==========================================================
# We use a list format for center to strictly control Folium
...
with col1:
    # Fuel Type is right at the top now for easy access
...
for _, row in stations_df.iterrows():
    ...
    # The HTML popup that shows on Click 1
    popup_html = f"""
...
# Hard-passing the center and zoom to force Streamlit to respect the user's view
...
# Capture map movements to prevent resetting
...
# Catch exact click coordinates to identify which servo was clicked
...
# ==========================================================
# CALCULATOR SECTION (Only shows if servos are added)
# ==========================================================
st.divider()
